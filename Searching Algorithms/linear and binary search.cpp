...
void linear_search(int array[], int size)
{
	...
	if(found)
		std::cout << "\tThe item: " << item_to_find << " is found in the given array at index: " << index << ".\n";
	else 
		std::cout << "\tThe item: " << item_to_find << " is not found in the given array.\n";
}
...
void binary_searching(int array[], int size)
{
	...
	std::cout << "\n\n\tElements in array in sorted order are: \n\t";
	for(int i= 0; i < 15; i++)
	{
	...
	if(data_index != -1)
		std::cout << "\tThe item: " << item_to_find << " is found in the given array at index: " << data_index << ".\n";
	else 
		std::cout << "\tThe item: " << item_to_find << " is not found in the given array.\n";
}
